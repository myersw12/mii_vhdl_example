...
If you are not familiar with the Vivado project structure, here are links to the [top level component](mii_vhdl_example/vhdl_mii.srcs/sources_1/imports/mii_vhdl_example/ethernet.vhd)
